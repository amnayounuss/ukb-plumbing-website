  ...
  return <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {servicesList.map(service => <Link to={`/services/${service.slug}`} key={service.id} className="group bg-white rounded-lg overflow-hidden shadow-subtle hover:shadow-lg transition-all duration-300">
